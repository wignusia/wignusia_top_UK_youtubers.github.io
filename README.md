...
* **[ Excel Workbook](https://github.com/wignusia/wignusia_top_PL_youtubers.github.io/blob/main/asset/docs/pl_youtubers_analysis_workbook_2024.xlsx)** – Contains all raw YouTube metrics and manual cleaning steps.
* **[SQL Scripts Folder](https://github.com/wignusia/wignusia_top_PL_youtubers.github.io/tree/main/asset/scripts/sql)** – Includes the queries used to extract and transform the data.
